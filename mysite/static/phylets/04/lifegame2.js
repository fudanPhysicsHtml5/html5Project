...
const start_x = document.getElementById("game").offsetLeft;
const start_y = document.getElementById("game").offsetTop;

let mouseListener = function (e) {
    let x = Math.floor((e.pageX - start_x) / WIDTH);
    let y = Math.floor((e.pageY - start_y) / WIDTH);
